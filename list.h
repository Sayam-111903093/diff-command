...
typedef struct node_lcs{
	...
	int line1;  //line number of file 1
	int line2;  //line number of file 2
}node_lcs;
...
list_lcs lcs(list l1, list l2, char ch);  //this takes both list and option given in command line
